class Carrito {
  ...
  // que lea los datos del producto del  html
  leerDatosProducto(producto) {
    ...
    //Al agregar al carrito el productos

    //Que primero chequee si ya estaba en el carrito anteriormente, si es así que arroje el cartel que ya esta en el carrito
    if (productosLS === infoProducto.id) {
      Swal.fire({
        type: "info",
        text: "El producto ya está en su carrito",
  ...
  eliminarProductoLocalStorage(productoID) {
    ...
    //Añadimos el array actual al LS
  ...
  procesarPedido(e) {
    ...
    if (this.obtenerProductosLocalStorage().length === 0) {
      //Si esta vacio que no lo procese
      Swal.fire({
        type: "error",
        title: "Oops...",
  ...
  //recordar usarlo cuando termine el html 
  calcularTotal() {
    let productosLS;
    let total = 0,
      iva = 0,
